...
from .scheduling import (
    ...
    TaskType,
    Property51Type,
    # Variant notification names (sub-types of property 2:51, not separate MQTT properties)
    ...
    DND_END_FIELD,
    DND_ENABLED_FIELD,
    TIME_SYNC_TIMESTAMP_FIELD,
    TIME_SYNC_TIMEZONE_FIELD,
    SIXTH_VARIANT_TYPE_FIELD,
)
